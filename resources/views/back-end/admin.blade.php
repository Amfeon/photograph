    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="item text-center">
                ...
                <a href="{{asset(route('slider.edit'))}}" class="btn btn-success">изменить слайдер</a>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="item text-center">
                <h3 class="item__title ">Фотосессии</h3>
                <a href="{{route('gallery.show')}}" class="btn btn-success">изменить фотосессии</a>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="item text-center">
              <h3 class="item__title ">Заявки</h3>
              <a href="{{route('applications.show')}}" class="btn btn-success">Показать заявки</a>
            </div>
        </div>
    </div>
    <div class="row">
